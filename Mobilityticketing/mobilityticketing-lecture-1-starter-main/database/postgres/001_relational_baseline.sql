...
create table route_stops (
    ...
    /* 
    Det samme stop må gerne forekomme flere gange på samme rute, 
    men med forskellige stop_sequence værdier. 
    Det kan f.eks. være tilfældet, hvis start og slutstop er det samme.
    */
